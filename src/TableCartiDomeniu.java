...
public class TableCartiDomeniu extends JFrame {

	private JPanel contentPane;
	private JComboBox comboBox;
	private JButton btnNewButton;
	private Tabel3 tabel3 = new Tabel3("Calatorie");
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TableCartiDomeniu frame = new TableCartiDomeniu();
	...
	public TableCartiDomeniu() {
		...
		String[] string= {"Domenii:","Clasic","Arte","Memorialistic","Poezie","Nonfictiune","Informare","Calatorie","Stiinta"};
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				new Tabel3(nume).setVisible(true);
;			}
		});
